...
class CrimeReport(db.Model):
    ...
    user_id = db.Column(db.Integer, db.ForeignKey('user.id'), nullable=True)  # Made nullable for anonymous reports
...
class SOSAlert(db.Model):
    ...
    is_anonymous = db.Column(db.Boolean, default=False)  # Added field for anonymous SOS alerts
